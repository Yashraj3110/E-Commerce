...
export default function Cart({ CartOpen, onCartClose }) {
    ...
    return (
        <>
            ...
            <div
                className={`fixed right-0 top-0 max-w-xs w-full h-full px-6 py-4 transition duration-300 transform overflow-y-auto bg-white border-l-2 border-gray-300 ${isCartOpen ? "block animate__animated animate__fadeInRight" : "hidden"
                    }`} 
                style={{ zIndex: "20" }}
            >
